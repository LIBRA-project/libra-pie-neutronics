...
def make_model(salt_material, salt_thickness, salt_height, 
               multiplier_thickness, multiplier_height, 
               reflector_thickness):
    """Make a basic model of LIBRA 4Pi with no heater, gas, fill, or thermocouple tubes."""

    # Initialize masses dictionary
    masses = {}
    ...
    multiplier_bot_plane = openmc.ZPlane(multiplier_top_plane_2.z0 - multiplier_height)
    ...
    masses['salt'] = salt_volume * salt_material.get_mass_density()
