...
center_tank_heat_tube_in_cyl = openmc.ZCylinder(r=0.5*2.54)
center_tank_heat_tube_out_cyl = openmc.ZCylinder(r=center_tank_heat_tube_in_cyl.r+0.2)
center_tank_heater_plane_1 = openmc.ZPlane(center_tank_bot_plane_4.z0 + 3)
...
center_tank_headspace_reg = -center_tank_cyl_1 & +center_tank_heat_tube_out_cyl & +center_tank_salt_top_plane & -center_tank_top_plane_1
