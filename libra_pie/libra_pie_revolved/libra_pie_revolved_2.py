...
outer_cyl_4 = openmc.ZCylinder(r=44.77, boundary_type='vacuum')

z_plane_1 = openmc.ZPlane(0.0, boundary_type='vacuum')
...
salt_gas_tube_top_plane = openmc.ZPlane(tank_top_cover_plane_1.z0 + 25.40, boundary_type='vacuum')
...
for multiplier_thickness in multiplier_thicknesses:
    ...
    inner_air_reg = -inner_cyl_1 & -salt_gas_tube_top_plane & +z_plane_1 & +x_plane_1 & +y_plane_1 \
                    & ~multiplier_reg
    # thermocouple_tube_air = 
    ...
    libra_quarter_1_cells = [out_wall_cell, wall_gap_cell, inner_wall_cell,
            ...
            multiplier_cell, libra_outside_air_cell]
